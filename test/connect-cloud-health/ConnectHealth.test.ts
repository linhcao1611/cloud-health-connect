...
describe("Connect Cloud Health test suite", () => {
  it("Liveness returns 200 OK on startup check starting", (done) => {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
      end: function (): http.ServerResponse {
        let expectedStatus = 200;
        let code = resStub.statusCode ? resStub.statusCode : 0;
        code.should.equals(
          expectedStatus,
          `Should return: ${expectedStatus}, but returned: ${code}`
        );
        done();
    ...
    LivenessEndpoint(cloudHealth)(
      <http.IncomingMessage>reqStub,
      <http.ServerResponse>resStub,
      <NextFunction>nextStub
    );
  });
  ...
  it("Liveness returns 200 OK and UP on liveness success", (done) => {
    ...
    const resStub: Partial<http.ServerResponse> = {
      ...
      //write: sinon.stub(),
        ...
        let expectedBody =
          '{"status":"UP","checks":[{"name":"test1","state":"UP","data":{"reason":""}}]}';
  ...
  it("Liveness returns 503 Unavailable and DOWN on liveness fail", function (done) {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
        ...
        let expectedBody =
          '{"status":"DOWN","checks":[{"name":"test1","state":"DOWN","data":{"reason":"Liveness Failure"}}]}';
        sinon.assert.calledWith(resStub.write as sinon.SinonStub, expectedBody);
        done();
        return this as http.ServerResponse;
      },
  ...
  it("Liveness returns 503 OK and STOPPING on STOPPING", function (done) {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
        ...
        let expectedBody =
          '{"status":"STOPPING","checks":[{"name":"test1","state":"STOPPING","data":{"reason":""}}]}';
        sinon.assert.calledWith(resStub.write as sinon.SinonStub, expectedBody);
        done();
        return this as http.ServerResponse;
      },
  ...
  it("Liveness returns 503 OK and STOPPED on STOPPED", function (done) {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
      end: function (cb?: () => void): http.ServerResponse {
        let expectedStatus = 503;
        let code = resStub.statusCode ? resStub.statusCode : 0;
        code.should.equals(
          expectedStatus,
        ...
        let expectedBody =
          '{"status":"STOPPED","checks":[{"name":"test1","state":"STOPPED","data":{"reason":""}}]}';
        sinon.assert.calledWith(resStub.write as sinon.SinonStub, expectedBody);
        done();
        return this as http.ServerResponse;
      },
  ...
  it("Readiness returns 503 Unavailable and DOWN on startup fail", function (done) {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
        ...
        let expectedBody =
          '{"status":"DOWN","checks":[{"name":"test1","state":"DOWN","data":{"reason":"Startup Failure"}}]}';
        sinon.assert.calledWith(resStub.write as sinon.SinonStub, expectedBody);
        done();
        return this as http.ServerResponse;
      },
  ...
  it("Readiness returns 200 OK and UP on startup and liveness checks", function (done) {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
        ...
        let expectedBody =
          '{"status":"UP","checks":[{"name":"readiness","state":"UP","data":{"reason":""}}]}';
        sinon.assert.calledWith(resStub.write as sinon.SinonStub, expectedBody);
        done();
        return this as http.ServerResponse;
      },
  ...
  it("Readiness returns 503 OK and STOPPING on STOPPING", function (done) {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
        ...
        return this as http.ServerResponse; // Add return statement here
      },
    };
    process.once("SIGTERM", () => {
      ReadinessEndpoint(cloudHealth)(
  ...
  it("Health returns 503 Unavailable and STARTING on startup check starting", (done) => {
    ...
    const resStub: Partial<http.ServerResponse> = {
      write: sinon.fake(),
        ...
        let expectedBody =
          '{"status":"STARTING","checks":[{"name":"StartCheck","state":"STARTING","data":{"reason":""}}]}';
        sinon.assert.calledWith(resStub.write as sinon.SinonStub, expectedBody);
        done();
        return this as http.ServerResponse; // Add return statement here
      },
